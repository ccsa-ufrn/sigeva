      ...
      <tr>
        <td>
          ...
          <div className="collapse" id={`clps-${this.props.object.data._id}`}>
            ...
            <a className="btn btn-success">Consolidar atividade</a>
            </div>
          </div>
        </td>
      </tr>
    ...
    return(
      <div>
                ...
                <div className="card-body">
                  ...
                  <table>
                    ...
                    { this.props.allObjects &&
                      this.props.allObjects.filter( obj=>obj.data.state === "approved" ).filter((object) => {
                        ...
                        return (
                          <tr key={submission._id}>
                            <td>
                              <strong>{submission.data.title}</strong><br/>
                              {submission.data.consolidation.location}
                            </td>
                          </tr>
                        );
                      })
        ...
        <table className="table">
          ...
          <tbody>
            { this.props.allObjects &&
              this.props.allObjects.filter(s => s.data.state === "approved").map((object) => {
                return (
